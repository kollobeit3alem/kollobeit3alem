  ...
  return (
    <div className="min-h-screen bg-page-bg flex flex-col relative" dir="rtl">
      ...
      <header className="bg-white py-4 px-[5%] flex justify-between items-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] sticky top-0 z-[100] border-b-[3px] border-b-primary">
        <Link href="/courses" className="flex items-center gap-4 no-underline">
        ...
        <div className="flex items-center gap-5">
          <Link href="/courses" className="bg-primary/10 text-primary no-underline py-2.5 px-5 rounded-xl font-bold transition-all hover:bg-primary hover:text-white flex items-center gap-2">
            ...
            <div>
              {isLoading ? (
                ...
                <div className="text-center py-16 bg-white rounded-[20px] border border-border shadow-sm">
                  ...
                  <Link href="/courses" className="bg-primary/10 text-primary no-underline py-3 px-8 rounded-xl font-bold transition-all hover:bg-primary hover:text-white inline-flex items-center gap-2">
